...
const Header = () => {
  return (
    ...
    <div className="flex justify-between items-center p-4 bg-white shadow-md sticky top-0 left-0 right-0">
      <div className="text-2xl font-bold text-red-600">Ajo<span className="text-gray-300">Zave</span></div>
      <div className="flex space-x-4">

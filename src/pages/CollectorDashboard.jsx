...
const CollectorDashboard = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      {/* Progress Section */}
      {/* <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-6 rounded-b-3xl shadow-md"> */}
      <div className="bg-custom-gradient text-white p-6 rounded-b-3xl shadow-md">
